...
* **Supplement safety layer:** Selenium, magnesium, omega-3, iron, vitamin D, folate, creatine, vitamin A, iodine, zinc, potassium, calcium, vitamin K, and vitamin B6 prompts are food-first and medication-aware. They ask for labels, labs, life-stage, kidney/liver, thyroid, anticoagulant, neurologic-symptom, or other clinical context where appropriate; explicit reproductive context can surface relevant nutrient-safety questions before a marker or product is entered. They do not infer supplement need, dose, safety, or efficacy from a common SNP.
* **Cycle-support layer:** When the person selects a relevant context, reports expose structured timing logs, PMDD-like symptom tracking, exact contraceptive ingredient prompts, cycle-linked pain/headache/migraine and aura questions, medication-use/overuse awareness, food/supplement/sleep/activity experiments with avoidances and label review, exogenous hormone product/route/dose/monitoring questions, pregnancy/postpartum/lactation medication and feeding-exposure review, preconception and fertility-care questions for different bodies and family-building paths, symptom-day support, heavy-bleeding/pelvic-pain escalation, adenomyosis workup boundaries, or androgen/prostate/testicular follow-up. With no selection, context-specific guidance and medication-composition warnings remain hidden unless an explicitly supplied medication name makes a label guardrail relevant. The layer does not infer current estrogen/progesterone, hormone regimen, pregnancy/lactation status, fertility, PMDD, migraine type, dysmenorrhea, adenomyosis, or medication response from DNA.
* **Runtime support-resource layer:** AI consultations receive pack-aware evidence policy, 17 resource-authored phenotype question domains, lab overlays, callability rules, food-decision constraints, medication safety notes, PRS limits, activity stop-sign guardrails, and cycle-support guidance. Each selected phenotype domain carries its registered evidence sources into the consultation payload. Self-reported body-system and reproductive/hormone context is kept separate from conservative chromosome-call context. Default AI instructions, JSON-context rules, and forbidden actions are authored in `ai_prompt_policy.json`; user-facing specialty-mode labels, safety instructions, optional mode-to-pack routing, active-finding quick helpers, and phenotype prompts are authored in JSON resources, so adding a new body-system or goal does not require parallel UI and TypeScript routing edits.
...
* **Broader conditional follow-up:** Metabolic, cardiovascular, thyroid, sleep, PGx, neuropsych, connective-tissue, and allergy/food-reaction markers can now surface structured symptom, timing, exposure, medication, family-history, and confirmatory-care prompts. Examples include A1C/fasting glucose, lipid/Lp(a)/ApoB, TSH/free T4, sleep studies when indicated, clinical PGx review, or allergist-directed testing. These rules remain phenotype- and lab-conditioned; common SNPs do not diagnose disease, assign personality or intent, infer current hormone levels, or determine medication response.
