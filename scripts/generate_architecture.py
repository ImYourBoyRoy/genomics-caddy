...
EXPLICIT = {
    ...
    "src-tauri/Cargo.toml": "Rust crate manifest, edition, and dependencies.",
    "src-tauri/tauri.conf.json": "Tauri window, CSP, bundle, and identifier config.",
    "src-tauri/build.rs": "Tauri build script hook.",
    "src-tauri/capabilities/default.json": "Tauri capability permissions for the webview.",
    ...
    "src-tauri/src/bin/inspect_db.rs": "CLI helper: print resolved data-dir and genome DB paths.",
    "src-tauri/src/bin/seed_mcp_fixture.rs": "CLI helper: seed a disposable MCP test fixture database.",
    ".cursor/skills/connections-vector-providers/reference.md": "Vector-store adapter dispatch notes for Connections providers.",
    ".github/workflows/release.yml": "GitHub Actions release workflow for desktop builds.",
