...
* **`npm run audit:resources`**: Audits every curated pack and support resource for probability/callability/actionability gates, claim-boundary fields, source-registry coverage, runtime parity, actionability coverage, and wording that needs human review.
