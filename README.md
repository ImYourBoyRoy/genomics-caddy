...
* **Cycle-support layer:** Menstrual and reproductive reports expose structured timing logs, PMDD-like symptom tracking, exact contraceptive ingredient prompts, symptom-day support, heavy-bleeding/pelvic-pain escalation, and adenomyosis workup boundaries. The layer does not infer current estrogen/progesterone, PMDD, adenomyosis, or medication response from DNA.
