...
mustContain("scripts/package_windows_portable.mjs", "signer");
mustContain("scripts/package_windows_portable.mjs", "${zipPath}.sig");
mustContain("src-tauri/src/portable_update.rs", "apply_portable_update");
mustContain("src-tauri/src/portable_update.rs", "GenomicsCaddy-portable-windows.zip");
mustContain("src-tauri/src/lib.rs", "CloseRequested");
mustContain("src/lib/utils/updater.ts", "kind === 'portable'");
mustContain("src/lib/utils/updater.ts", "apply_portable_update");
