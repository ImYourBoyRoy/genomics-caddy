...
* Shared report/sidebar and Chromosome Map tooltips support keyboard focus, hover, click/tap pinning for informational triggers, Escape, click-away dismissal, reduced motion, and viewport-aware placement; wrapped action controls dismiss their explanatory tooltip after activation so it cannot cover the resulting UI state.
