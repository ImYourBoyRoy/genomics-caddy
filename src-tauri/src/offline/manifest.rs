...
impl OfflineAssetId {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ClinvarSubmissionSummary => "clinvar_submission_summary",
    ...
    pub fn from_str_id(s: &str) -> Option<Self> {
        match s {
            ...
            "clinvar_submission_summary" => Some(Self::ClinvarSubmissionSummary),
...
pub fn all_assets() -> &'static [OfflineAssetDef] {
    &[
        ...
        OfflineAssetDef {
            id: OfflineAssetId::ClinvarSubmissionSummary,
            tier: 1,
            label: "ClinVar submission summary",
            url: Some(
